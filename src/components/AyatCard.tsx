      ...
      <div className="space-y-4">
        ...
        <div className="bg-white p-5 rounded-lg border-2 border-amber-100 mb-5 shadow-sm">
          ...
          <div className="mt-4 pt-4 border-t-2 border-amber-100">
            <p className="text-book-text text-left text-lg font-bold bg-gradient-to-r from-amber-100 to-amber-200 rounded-lg px-3 py-2 shadow-inner border border-amber-200">
              {ayat.teksIndonesia}
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-wrap items-center gap-3 justify-between">
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className={`
                  px-4 py-2.5 rounded-lg font-semibold text-base
                ...
                {showTafsir ? (
                  <span className="font-bold flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 font-bold text-amber-700 drop-shadow-lg" viewBox="0 0 24 24" fill="currentColor">
                      <path fillRule="evenodd" d="M12 6c.28 0 .53.11.71.29l6 6a1 1 0 01-1.42 1.42L13 9.41V18a1 1 0 11-2 0V9.41l-4.29 4.3a1 1 01-1.42-1.42l6-6A1 1 0 0112 6z" clipRule="evenodd" />
                    </svg>
