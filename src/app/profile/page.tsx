                                  ...
                                  <div className="divide-y divide-amber-100 w-full">
                                    {sortedBookmarks.map((bookmark) => (
                                      <div 
                                        ...
                                        className="p-3 hover:bg-amber-100/50 transition-colors cursor-pointer"
                                        ...
                                        <div className="flex space-x-2">
                                          <button 
                                            onClick={(e) => {
                                              ...
                                              navigateToSurah(bookmark.surah_id, bookmark.ayat_number);
                                            }} 
                                  ...
                                  <div className="divide-y divide-rose-100 w-full">
                                    {sortedFavorites.map((favorite) => (
                                      <div 
                                        ...
                                        className="p-3 hover:bg-rose-100/50 transition-colors cursor-pointer"
                                          ...
                                          <div className="flex space-x-2">
                                            <button 
                                              onClick={(e) => {
                                                ...
                                                navigateToSurah(favorite.surah_id, favorite.ayat_number);
                                              }} 
                                  ...
                                  <div className="divide-y divide-green-100 w-full">
                                    {sortedNotes.map((note) => (
                                      <div 
                                        ...
                                        className="p-3 hover:bg-green-100/50 transition-colors cursor-pointer"
                                      ...
                                      >
                                        <div className="space-y-2">
                                          <div className="flex justify-between items-start">
                                            ...
                                            <div className="flex space-x-2">
                                              <button 
                                                onClick={(e) => {
                                                  e.stopPropagation(); // Prevent navigation when clicking the button
                                                  navigateToSurah(note.surah_id, note.ayat_number);
                                                }} 
                                          ...
                                          <div className="bg-white p-3 rounded border border-green-100" onClick={(e) => e.stopPropagation()}>
