  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        } else if (result.error === "This account uses Google or Facebook to sign in") {
          setError("Akun ini menggunakan Google atau Facebook untuk masuk");
        } else {
      ...
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white p-8 rounded-lg shadow-md border border-amber-200">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Akses bookmark dan ayat favorit Anda</p>
          </div>
